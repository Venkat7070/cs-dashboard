    ...
    <div className="fixed inset-0 z-30 flex justify-end">
      ...
      >
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-4">
          <MetricCard label="P+V ARR" value={formatCurrency(account.arr)} title={formatCurrencyFull(account.arr)} />
          <MetricCard
            label="Total ARR"
            value={formatCurrency(account.totalArr)}
            title={formatCurrencyFull(account.totalArr)}
          />
          <MetricCard
